...
/// VISION.md names four screens; only the roll is designed. The other three are
/// routed to a placeholder so the navigation can be built and used now, and
/// each route's builder swapped as its screen lands.
///
